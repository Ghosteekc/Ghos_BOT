...
CLARIFY_PROMPT = (
    "Скажи задачу конкретнее — так совет будет рабочим, а не общим.\n\n"
    "Могу: собрать колоду, разобрать состав, улучшить карты, "
    "разобрать матчап или бой, объяснить карту/механику, "
    "подсказать план по кубкам или против архетипа.\n\n"
    "Напиши одну цель на этот ответ — не буду угадывать."
)

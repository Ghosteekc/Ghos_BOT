...
CLIMB_TIPS: tuple[str, ...] = (
    "Играйте одну колоду пачкой боёв — так стабильнее решения и цикл.",
    "После серии поражений разберите последний бой в Ghosteek (Battle Analyzer), а не меняйте всё сразу.",
    "Смотрите слабые матчапы через Matchup Analyzer и готовьте план, а не паникуйте в бою.",
    "Если колода «не заходит» — сначала Recommendation (замены), потом полная пересборка Builder.",
    "Держите карточный уровень конкурентоспособным для вашего диапазона кубков — иначе тактика не спасёт.",
)

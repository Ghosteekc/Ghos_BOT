...
MESSAGES: dict[str, str] = {
    ...
    # Нет боёв для статистики — не ошибка сервера, а пустое состояние
    "E025": (
        "Для ведения статистики нужно сыграть пару рейтинговых боёв в Clash Royale. "
        "После этого данные появятся здесь сами."
    ),
    # Поддержка / прочее
